...
This Milestone Report describes the exploratory data analysis carried out on the Capstone Project of the Data Science Coursera specialization.

Coursera and SwitfKey are partnering on this project; to apply data science in the area of natural language.
...
In this report is shown some information about the corpus of data and plan steps to create the predictive model.

## 2. R Packages and Libraries.

The key R Packages and Libraries installed and loaded to be used for this project.
...
## 3. Looking for / Loading the Data.
...
## 4. Some Data Details / Statistics.
...
## 5. Dara Sample (Subset).

The data is significantly large and could have poor performance in mobile.
...
## 6. Corpus File and Cleaning The Data.
...
### 6.2. Reading Final Corpus File as data.frame.
...
* All the process from reading files, cleaning and creating n-grams is time-consuming for your computer.
* NLP uses intensive computer resource and is necessary a lot of tests to get n-grams efficiently keeping minimum file sizes.
* The techniques of removing words (cleaning) sometimes is not as precise as we can expect.
* Increasing quality of n-gram tokenization could be critical for the prediction accuracy of the algorithm.

### 8.2. Next Steps.

* Build a Shiny app where a user can input a word and a suggestion of the next word is obtained. 
* Develop the prediction algorithm implemented in the Shiny app. 
