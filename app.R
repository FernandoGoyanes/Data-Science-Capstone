...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      p("Input a word or text and press <ENTER> or click <Predict> to see the next word(s) suggestion(s):"),	
  ...
  fluidRow(HTML("<div style='margin-left:18px;margin-bottom:12px;color:navy;'><strong>Creation date: April 2018</strong></div>") ),
  
  fluidRow(HTML("<div style='margin-left:18px;margin-bottom:12px;margin-top:-12px;color:navy;'><strong><big>By <a title='contact me' 
                
                href='mailto:fernando_goyanes@hotmail.co.uk'>Fernando Goyanes</a></big></strong></div>") )
